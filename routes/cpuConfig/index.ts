...
import {
  getRAM,
  getRAMs,
  getRAMsProcessorSpecific,
} from '../../controllers/cpuConfigurations/ram.controller';
 ...
 * @description To get specific Proessor
 * @route GET/ api/processors/:processor_id
 */
CPUConfigRouter.get('/processors/:processor_id', getProcessor);

/**
 * To View the Information of all the Processors
 * @description To get info for all Processors
...
/**
 * To View the Information of all the RAMs based on Processor
 * @description To get info for a rams specific to processor
 * @route GET/ api/cpuConfig/RAMsProcessorSpecific
 */
CPUConfigRouter.post('/RAMProcessorSpecific', getRAMsProcessorSpecific);
